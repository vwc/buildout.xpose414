/*!
* Xposeo Theme v1.0.0 by meetshaus
* Copyright Ade25
        ...
        function hasParentClass(e, classname) {
            ...
            function init() {
                ...
                var container = document.getElementById( 'app-container' ),
                    ...
                    buttons = Array.prototype.slice.call( document.querySelectorAll( '#app-menu-trigger > button' ) ),
                    // event type (if mobile use touch events)
                    eventtype = mobilecheck() ? 'touchstart' : 'click',
                    resetMenu = function() {
                        classie.remove( container, 'app-aside-open' );
                    },
                    bodyClickFn = function(evt) {
                        if( !hasParentClass( evt.target, 'app-aside' ) ) {
                            resetMenu();
                ...
                buttons.forEach( function( el, i ) {
                    ...
                    el.addEventListener( eventtype, function( ev ) {
                        ...
                        setTimeout( function() {
                            classie.add( container, 'app-aside-open' );
                        }, 25 );
